...
function useTheme() {
    const [theme, setThemeState] = useState<Theme>(() => {
        if (typeof window === "undefined" || typeof window.localStorage?.getItem !== "function") return "auto";
        return (window.localStorage.getItem("wtf-tez-theme") as Theme) ?? "auto";
    });
    ...
    useEffect(() => {
        ...
        if (typeof window.localStorage?.setItem === "function") {
            window.localStorage.setItem("wtf-tez-theme", theme);
        }
    }, [theme]);
