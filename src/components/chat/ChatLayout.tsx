...
import { chatParentDomains, hackchatUrl } from "../../config/tezos";

const HIDDEN_DMS_STORAGE_KEY = "wtf-tez-hidden-dms";
...
export default function ChatLayout({ token, domains, activeDomain, onSwitchDomain, onPinImage }: ChatLayoutProps) {
    ...
    const isAdmin = useMemo(
        () => chatParentDomains.some((parent) => currentDomain === `admin.${parent}`),
        [currentDomain],
    );
