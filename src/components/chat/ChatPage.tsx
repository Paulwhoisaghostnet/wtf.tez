...
const IDENTITY_STORAGE_KEY = "wtf-tez-chat-identity";
...
export default function ChatPage() {
    ...
    if (!address || !client) {
        return (
            ...
            >
                ...
                >
                    Connect your wallet to enter wtfchat
                </h2>
                <button
                    type="button"
                    onClick={connect}
    ...
    // Gate 3: authenticated but no configured chat domain
        ...
        return (
            ...
            >
                ...
                <h2
                    ...
                    style={{ fontFamily: "var(--font-mono)", letterSpacing: "0.15em" }}
                >
                    You need a {parentDomain} domain to chat
                </h2>
                <p
                    className="text-xs text-center max-w-md"
                    style={{ color: "var(--fg-2, rgba(255,255,255,0.6))", lineHeight: "1.7" }}
