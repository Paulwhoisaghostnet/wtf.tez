            ...
            >
                <header>
                    ...
                    <p style={{ color: "var(--fg-muted)", fontSize: "0.75rem" }}>
                        restricted to <span style={{ color: "var(--info)" }}>admin.{parentDomain}</span>
                    </p>
                </header>
            </div>
                ...
                <section>
                    ...
                    <div style={{ display: "flex", gap: "0.5rem", marginBottom: "1.25rem" }}>
                        <input
                            ...
                            onKeyDown={(e) => {
                                if (e.key === "Enter" && newMod.trim())
                                    act("addMod", async () => {
                                        await api.addModerator(newMod.trim());
                                        setNewMod("");
                                    });
                            }}
                            style={{
                        ...
                        <button
                            ...
                            style={{
                                ...
                                color: "var(--bg)",
                                border: "none",
                                cursor: busy === "addMod" ? "default" : "pointer",
                                opacity: busy === "addMod" || !newMod.trim() ? 0.4 : 1,
                                whiteSpace: "nowrap",
                            }}
                        >
                            + ADD
                    ...
                    {loading ? (
                        ...
                        <p style={{ color: "var(--fg-3)", fontFamily: "var(--font)", fontSize: "0.7rem" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "1px" }}>
                            {mods.map((m) => (
                                ...
                                >
                                    <div>
                                        <span
                                            style={{ fontFamily: "var(--font)", fontSize: "0.8rem", fontWeight: 700 }}
                                        >
                                            {m.domain}
                                        </span>
                                        <span
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem", marginBottom: "1.25rem" }}>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                color: "var(--bg)",
                                border: "none",
                                cursor: !catName.trim() ? "default" : "pointer",
                                opacity: !catName.trim() || busy === "addCat" ? 0.4 : 1,
                                            ...
                                            <div style={{ display: "flex", gap: "0.4rem" }}>
                                                <button
                                                    ...
                                                    style={{
                                                        ...
                                                        border: "none",
                                                        cursor: "pointer",
                                                        opacity: !editing.name.trim() ? 0.4 : 1,
                                                    }}
                                                >
                                                    SAVE
                                                </button>
